...
//            e.preventDefault();
    ...
    $('#realtimeLayer')
        ...
        .on('mouseup mouseout touchend', function(e, ui){
            clearTimeout(longClickTimer);
        ...
        .on('mousemove touchmove', function(e, ui){
            e.preventDefault();
...
WFEPController.prototype.showPointer = function(pointerInfo){
    ...
    // 調整
    pointerInfo.left = window.wfepcontroller.scaleTo(pointerInfo.left,pointerInfo.img_width,window.wfepcontroller.slidesizeW);
    pointerInfo.top = window.wfepcontroller.scaleTo(pointerInfo.top,pointerInfo.img_height,window.wfepcontroller.slidesizeH);
        ...
        switch(msg.type){
            ...
            case "count_clients":
                ...
                if(msg.response){
                    ...
                    }while(window.wfepcontroller.userID==1);
                }else{
                    var resmsg = {
                        type: "count_clients",
                        userid:msg.userid,
